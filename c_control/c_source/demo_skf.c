...
void EccGenerateKeyInterfaceTest()
{
    ...
    for(int i = 0; i < sizeof(tSm2SignPubkeyBlob1.XCoordinate); i++){
	printf("%x", tSm2SignPubkeyBlob1.XCoordinate[i]);
    }
    printf("\n");
    for(int i = 0; i < sizeof(tSm2SignPubkeyBlob1.YCoordinate); i++){
	printf("%x", tSm2SignPubkeyBlob1.YCoordinate[i]);
    }
    printf("\n");
